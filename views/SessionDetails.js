cfunited.ui.SessionDetails = Ext.extend(Ext.Panel,{
	...
	session_data[16] =
		...
		session_data[32] =
		{'id':32,'schedule':[{'seats':200,'starttime':'17:10','endtime':'18:10','date':'2010-07-30','location':'Auditorium Pelvoux'}],'description':'La morale de cette histoire VRAIE pourrait être: Pour réussir à être agile : Volonté, envie, courage, discipline … et un bon accompagnement. La session couvrira toutes les pratiques agiles du Product Owner, les changements de comportement vis-à-vis des utilisateurs et de l’équipe de réalisation, et les outils et métriques utilisés. Chaque pratique sera illustrée par une fable et des exemples concrets issus du projet. Bénéfices attendus pour les participants : Connaitre les « outils » réellement utilisé par un Product Owner sur un projet de 12 mois.','name':'Il était une fois un MOA qui voulait devenir Product Owner... et qui y réussit !','speakers':[{'id':11,'name':'Alexandre Boutin'}]} ;	


		session_data[33] =
		{'id':33,'schedule':[{'seats':200,'starttime':'17:10','endtime':'18:10','date':'2010-07-30','location':'Belle-Etoile'}],'description':'Les méthodes agiles occupent une place de plus en plus importante dans la gestion des projets informatiques. Tous les acteurs de l’entreprise sont sensibles à leurs promesses : meilleure écoute des gens du métier, meilleure implication des équipes de réalisation, meilleure visibilité des travaux en cours, meilleure qualité du résultat final. Ces promesses sont-elles tenues ? Objet Direct s’appuie sur des retours d’expériences nombreux et significatifs pour évaluer la pertinence des démarches agiles, leurs avantages réels, mais aussi les difficultés rencontrées. Gérer une équipe de 5 ou 6 personnes sur un projet d’environ 1000 jours n’est pas le même exercice que de gérer une équipe de 100 personnes sur des projets de 2 ans de délai. Heureusement, les méthodes agiles sont aussi variées que peuvent l’être les projets en entreprise. L’agilité offre de multiples réponses : Unified Process (UP), eXtreme Programming (XP) et la plus célèbre d’entre toutes : Scrum. Retour d’expérience projet Société Générale). Ce séminaire se propose de vous faire découvrir concrètement les principales démarches agiles et dans quel cadre nous pouvons les utiliser efficacement. Objet Direct capitalise sur de nombreux retours d’expériences projets pour vous présenter les meilleures pratiques à mettre en œuvre. Nous aborderons dans ce séminaire les difficultés rencontrées et des solutions pour les surmonter. Nous vous ferons part des principaux gains que l’agilité a apportés.','name':'L\'agilité : de la promesse à la réalité!','speakers':[{'id':49,'name':'Henri Darmet'}]} ;	

				session_data[34] =
		{'id':34,'schedule':[{'seats':200,'starttime':'17:10','endtime':'18:10','date':'2010-07-30','location':'Chartreuse'}],'description':'In soccer (a.k.a. international football), players play individual positions but all share core skills, like dribbling, passing and shooting. Their places on the field overlap and they interact with everyone else on the team. American football is different: Players are highly specialized and only step onto the field for certain plays. To achieve a whole-team approach in software development, we’ll look at practical ways that teams can emulate soccer teams by approaching work in terms of activities to be accomplished together, rather than in separate, specialized roles. We’ll also discuss how kanban affects teams’ tendency toward one or the other. Participants, both new to agile and those using newer methods like kanban, will interactively learn practical ways to foster or improve whole-team approach and realize its benefits.','name':'Play soccer, not American football: How to foster a whole-team approach by thinking in activities rather than roles','speakers':[{'id':2,'name':'Matthew Philip'}]} ;	

		session_data[35] =
		{'id':35,'schedule':[{'seats':200,'starttime':'17:10','endtime':'18:10','date':'2010-07-30','location':'Sept-Laux 5'}],'description':'Plusieurs entreprises se sont lancées dans le Lean. Certaines ne réussissent pas par manque de coordination dans le déploiement des plans d’actions ou par manque d’implication des salariés. La méthodologie « Hoshin Kanri » favorise par une transversalité et une fixation commune des plans d’actions, l’atteinte du « Grand Nord » (Vision et objectifs) de l’entreprise. Dans le cadre de l’implantation du Lean dans l’entreprise, comprendre en quoi la méthodologie « Hoshin Kanri » ainsi que la mise en place d’un changement culturel de management, sont des atouts essentiels dans un déploiement stratégique réussi.','name':'Le Lean et le déploiement stratégique (Hoshin Kanri)','speakers':[{'id':60,'name':'Sylvain Fortin'}]} ;	

		session_data[36] =
		{'id':36,'schedule':[{'seats':200,'starttime':'17:10','endtime':'18:10','date':'2010-07-30','location':'Sept-Laux 4'}],'description':'Depuis maintenant deux ans et demi, nous avons mis en place pas à pas les pratiques agiles chez Transatel une entreprise de téléphonie mobile (MVNO) de 70 personnes. A partir d’une première équipe, les pratiques se sont répandues sur l’ensemble des équipes de développements et partiellement sur les études et la QA. Nous vous proposons de découvrir notre parcours, nos difficultés et nos victoires avec un focus particulier sur les techniques de diffusion que nous avons utilisées. Un éclairage sur les difficultés rencontrées lors de la mise en place de l’agilité et l’utilisation de quelques techniques de diffusion inter-équipes.','name':'Transatel : 2 ans et demi de mise en place de l’agilité','speakers':[{'id':52,'name':'Jean-Baptiste Vilain'}]} ;	
		
		session_data[37] =
		{'id':37,'schedule':[{'seats':200,'starttime':'17:10','endtime':'18:10','date':'2010-07-30','location':'Meije 3'}],'description':'Dans Candide, Voltaire nous livre un message : il faut cultiver son Jardin. Un message philosophique intéressant à l’heure où les exigences ne cessent de croitre sur la fabrication de logiciel. Celle-ci ne cesse d’être comparée à la construction de bâtiments. Les méthodes de travail en sont très largement inspirées. Pourtant force est de constater qu’un logiciel est plus vivant que la pierre. En particulier, le parallèle avec le jardin est bien plus pertinent à bien des égards. Cette session est idéale pour s’ouvrir l’esprit et offrir une nouvelle perspective sur le développement logiciel.','name':'Il faut cultiver son Code','speakers':[{'id':53,'name':'Benoit Gantaume'}]} ;	


		session_data[38] =
		{'id':38,'schedule':[{'seats':200,'starttime':'17:10','endtime':'18:10','date':'2010-07-30','location':'Meije 2'}],'description':'Beaucoup connaissent ou utilisent déjà des outils d\'exigences exécutables comme Fitness, Cucumber ou GreenPepper. Par contre, la méthode plus globale qui permet de mieux en tirer profit n\'est pas encore bien maîtrisée. Venez vivre avec nous trois scènes qui illustrent le mise en pratique des exigences exécutables de façon efficace tout au long d\'un projet.<br/><br/>Scène 1 : L\'incompréhension <br/>Afin d\'améliorer la satisfaction des utilisateurs <br/>     et de livrer plus rapidement <br/>En tant que Client <br/>Je souhaite définir des exigences à forte valeur <br/>     et qu\'elles soient comprises par les autres acteurs du projet<br/><br/>Scène 2 : Dans l\'arène du code <br/>Afin d\'implanter les exigences du client <br/>     et que mon code soit maintenable/évolutif <br/>En tant que développeur <br/>Je souhaite que mon développement soit piloté par les exigences <br/>     et que mon code soit compréhensible par un autre développeur <br/>     et que je ne crée pas de régression fonctionnelle<br/><br/>Scène 3 : L\'effet tunnel <br/>Afin d\'éviter l\'effet tunnel (mauvaises surprises à la livraison) <br/>En tant qu\'acteur du projet <br/>Je souhaite connaitre l\'avancement tout au long du projet <br/>     et que l\'implantation soit conforme aux besoins <br/>     et qu\'il n\'y a pas de régression fonctionnelle','name':'Exigences Exécutables Efficaces : \'Doing the Right Software\'','speakers':[{'id':54,'name':'Bruno Orsier'},{'id':55,'name':'Remy Sanlaville'}]} ;	

		session_data[41] =
		{'id':41,'schedule':[{'seats':200,'starttime':'17:10','endtime':'18:10','date':'2010-07-30','location':''}],'description':'Hall','name':'Apéro offert par le CARA à tous les présents','speakers':[{'id':50,'name':'CARA'}]} ;	
