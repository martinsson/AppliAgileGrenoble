...
session_data[47] = {'id':47,'schedule':[{'seats':0,'starttime':'08:00','endtime':'08:45','date':'2011-11-24','location':'Atrium'}],'description':'','name':'Accueil autour d\'un café','speakers':[{'id':69,'name':'Club Agile Rhône Alpes'}]};
session_data[41] = {'id':41,'schedule':[{'seats':450,'starttime':'08:45','endtime':'09:00','date':'2011-11-24','location':'Auditorium'}],'description':'','name':'Le mot des organisateurs & Sponsor SAMSE','speakers':[{'id':63,'name':'Club Agile Rhône Alpes'}]};
session_data[42] = {'id':42,'schedule':[{'seats':450,'starttime':'09:00','endtime':'09:45','date':'2011-11-24','location':'Auditorium'}],'description':'','name':'Starting An Agile Transition with Why','speakers':[{'id':64,'name':'Karl Scotland'}]};
...
session_data[43] = {'id':43,'schedule':[{'seats':450,'starttime':'12:20','endtime':'12:45','date':'2011-11-24','location':'Auditorium'}],'description':'Pourquoi le code propre est si important : Projection de l\'épisode 1 de Uncle Bobs Clean Code videos. Cette session s\'adresse à tout le monde dans l\'industrie, développeur ou non. A la fin cette projection deux lots de 6 vidéos sont offerts! Participez gratuitement à la tombola.','name':'Clean Code','speakers':[{'id':65,'name':'Clean Code'}]};
session_data[44] = {'id':44,'schedule':[{'seats':450,'starttime':'13:20','endtime':'13:35','date':'2011-11-24','location':'Auditorium'}],'description':'','name':'Slam!','speakers':[{'id':66,'name':'Un Deux Ground'}]};
session_data[45] = {'id':45,'schedule':[{'seats':450,'starttime':'13:35','endtime':'13:45','date':'2011-11-24','location':'Auditorium'}],'description':'','name':'Le mot des organisateurs & Sponsor SOGILIS','speakers':[{'id':67,'name':'Club Agile Rhône Alpes'}]};
session_data[46] = {'id':46,'schedule':[{'seats':450,'starttime':'13:45','endtime':'14:30','date':'2011-11-24','location':'Auditorium'}],'description':'','name':'How to Change the World','speakers':[{'id':68,'name':'Jürgen Appelo'}]};
